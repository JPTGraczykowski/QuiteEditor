class LineItemsController < ApplicationController
  ...
  def create
    ...
    if @line_item.save
      respond_to do |format|
        format.html { redirect_to @quote, notice: "Item was successfully created." }
  ...
  def update
    if @line_item.update(line_item_params)
      respond_to do |format|
        format.html { redirect_to @quote, notice: "Item was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @quote, notice: "Item was successfully destroyed." }
